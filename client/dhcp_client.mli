...
(** [create ~options ~requests xid mac] returns a pair of [t, buffer].  [t] represents the current
    ...
    [options] is a list of options which the client will send in the DHCP
